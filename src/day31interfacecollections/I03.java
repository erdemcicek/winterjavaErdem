...
/*
 		...
 		1) If you want to create "methods with body" in interfaces you have two options;
 			...
 			If you create a method in an interface by using "default" keyword,
 			those methods are called "default methods"
 		...
 		Note: Difference between "default methods" and "static methods" in an interface
 			a) "default methods" can be called just by "objects" but "static methods" can be 
 				called by using "interface" names
 			b) If you create "default methods" or "static methods" in an interface no need to 
 				override them. Overriding is optional for "default methods" and "static methods"
