...
/*
 	1) Static Block is used to initialize "static variables" ( which means class variables )
...
public class StaticBlock {
	...
	static {
		...
		age = 23; // static block executes before everything in the class, even before codes in the main method. 
	}
	static {
